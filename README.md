...
[![npm downloads](https://img.shields.io/npm/dw/@recap.dev/serverless-plugin)](https://www.npmjs.com/package/@recap.dev/serverless-plugin) [![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/infinite-cat/recap.dev-serverless-plugin/blob/master/LICENSE) [![recap.dev Docker Hub](https://img.shields.io/badge/Docker%20Hub-recapdev%2Fserver-informational "recap.dev Docker Hub")](https://hub.docker.com/repository/docker/recapdev/server)
...
**recap.dev-serverless-plugin** repository is a Serverless Framework plugin that automatically wraps your handlers and sends the tracing data to the recap.dev server.

[Learn how to use this plugin to integrate your Serverless application with recap.dev](https://recap.dev/docs/tracing#serverless-framework)
